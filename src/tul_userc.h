...
int client_get_message(char *uid, char *t_uid, char *pass, tul_net_context *conn, unsigned long long offset, char **msg, unsigned long long *ret_offset, unsigned *_new, char *uname);
